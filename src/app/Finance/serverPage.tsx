          ...
          <div className="w-[50vw] p-5 flex flex-col justify-start items-start overflow-x-hidden overflow-y-scroll">
            ...
            <div date-rangepicker className="flex items-center">
              <div className="relative">
                ...
                <input min={today} onChange={(e) => setStartDate(e.target.value)} name="start" type="text" className="bg-gray-50 outline-none border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="Select date start"/>
              </div>
              ...
              <div className="relative">
                ...
                <input min={startDate} onChange={(e) => setEndDate(e.target.value)} name="end" type="text" className="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded-lg  block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"  placeholder="Select date end"/>
              </div>
            </div>
