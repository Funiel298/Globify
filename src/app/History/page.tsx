...
export default function History(){
    return(
        ...
        <div>
            <img src={'https://www.fjordtours.com/media/old/7728/img_20180405_104900-01.jpeg?anchor=center&mode=crop&width=1120&height=630&rnd=132246818030000000&slimmage=True'} alt=""  className="w-full h-[30vw] object-cover " />
            <div className="flex justify-center ">
                ...
                <CenterParagraphs name={'A Brief History of Norway'}>
                    <h5>
                        ...
                        <br /><br />
                        <span className='font-semibold text-lg'>The Viking era</span><br />
                        <br />
                        ...
                        <div className="flex flex-row justify-around">
                            <img className="w-[30%]" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Gjermundbu_helmet_-_cropped.jpg/210px-Gjermundbu_helmet_-_cropped.jpg" alt=""  />
                            <img className=" w-2/3" src="https://viking.style/wp-content/uploads/2023/04/Vikings-Origin.jpg" alt=""  />
                        </div>

                        <br /><span className='font-semibold text-lg'>Stave churches</span><br /><br />
            ...
            <div className="px-40 flex flex-row justify-around items-center ">
                <div>
                    <h1 className="font-bold text-2xl">Sources Links</h1>
                    <a href="">Wikipedia/Norway</a>
                </div>
                <div>
